...
const LocationPicker = ({ onSelectLocation }: LocationPickerProps) => {
  ...
  return (
    <section id="destinations" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold tracking-tight">Discover Premier Fishing Destinations</h2>
        <p className="text-base md:text-lg text-muted-foreground max-w-2xl mt-2 mx-auto">
          Select from our curated list of world-class fly fishing locations or search for your dream destination
        </p>
      </motion.div>
